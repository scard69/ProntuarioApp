angular.module('PacienteModule', []).controller('PacienteController', function ($scope, $http) {
    ...
    $scope.consultar = function (paciente) {
        $http.get($scope.urlApi + '/pacientes/' + paciente.codigo)
             .success(function (data) {
                console.log(data);
                $scope.fields = data;
        });
    ...
    $scope.excluir = function (paciente) {
        $http.delete($scope.urlApi + '/pacientes/' + paciente.codigo)
             .success(function (data) {
                console.log(data);
                $scope.fields = data;
                $scope.todos();
